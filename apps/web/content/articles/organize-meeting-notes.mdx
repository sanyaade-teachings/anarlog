...
Anarlog, on the other hand, saves your notes as plain markdown files on your own device. That one difference opens up a lot.

Markdown files are just text. Any tool can read them, which means your meeting history isn't locked in a platform. The files travel with you and work with anything, regardless of what Anarlog does in the future.
