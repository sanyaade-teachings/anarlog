...
[Anarlog](/) is an open-source AI notepad for meetings built for Mac. Everything is stored as plain markdown files on your device. You choose your AI stack: managed cloud, BYOK, or run local models. Zero lock-in.
