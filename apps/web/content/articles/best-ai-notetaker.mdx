...
Anarlog exists because of that. It's an open-source AI notepad for meetings that stores everything as plain markdown files on your device. Zero lock-in. You choose your AI stack: managed cloud, bring your own API keys, or run local models. No bots. No vendor dependency.
...
Anarlog records your microphone and system audio directly on your Mac. No bot, no cloud dependency, everything stored as plain markdown files you own.
...
Anarlog gives you complete control because everything is stored as plain markdown files on your device. You choose which AI processes your data—or keep it fully local. IT teams can audit the open-source code, and you can use the AI provider your security team approves.
