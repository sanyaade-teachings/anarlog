...
- Legacy local models are now labeled as deprecated, the legacy Anarlog provider card has been removed, and local model folder/delete controls live directly in the model picker
