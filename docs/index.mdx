...
Anarlog records your microphone and computer audio without joining the call as a bot. Each meeting stays together as an editable memo, transcript, and summary.
...
<CardGroup cols={2}>
  ...
  <Card title="Choose your AI" icon="sparkles" href="/ai-setup">
    Use Anarlog Cloud, your own provider, or local models.
  </Card>
</CardGroup>
